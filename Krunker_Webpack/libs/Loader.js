...
class Loader extends Events {
	...
	async license(input_meta){
		...
		try{
			...
			meta = {
				error: {
					title: err.message,
					message: `Ask in our Discord for help or or <a href='/'>click here</a> to try again.`,
				},
			};
		}
	...
	async load(add_args = {}, add_context = {}, before_load = () => {}){
		...
		try{
			...
			this.show_error(err.message, `Ask in our Discord for help or or <a href='/'>click here</a> to try again.`);
		}
	}
};
